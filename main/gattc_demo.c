        ...
        case ESP_GAP_SEARCH_INQ_RES_EVT:
            ...
            switch(*payload)
			{
                ...
                case 0x03:
                    ...
                    if (length-1 == 2){
                        found_uuid = (esp_bt_uuid_t) { .len = ESP_UUID_LEN_16,
                        .uuid = {.uuid16 = (((uint16_t)uuidPtr[1] << 8) | uuidPtr[0]),},
                        };
                    }
                    break;
            ...
            //                                     ESP_BLE_AD_TYPE_16SRV_CMPL, &adv_name_len);
            // ESP_LOGI(GATTC_TAG, "found uuid %d", *adv_name);
